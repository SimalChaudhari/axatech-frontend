...
export default function CloudTable({ plans, onOpenEdit, onRemove, loading = false }) {
  ...
  const filteredPlans = useMemo(() => {
    return plans.filter((p) => {
      ...
      if (searchQuery.trim()) {
        ...
        if (!planName.includes(q) && !type.includes(q) && !period.includes(q) && !description.includes(q)) {
          return false;
        }
      }
      return true;
